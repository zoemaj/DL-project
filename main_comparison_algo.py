...
if __name__=="__main__":
    ...
    comparison_algo.execute(path_folder=args.path_folder,list_application=args.list_application,plots_name=args.plots_name,list_visualisation=args.list_visualisation)
